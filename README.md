...
- [**train-electrode-keypointdiff**](https://github.com/QidiLiu/X-ray_Defect_Detection/tree/train-electrode-keypointdiff): Diffusion solution, focusing on the electrode detection stage.
